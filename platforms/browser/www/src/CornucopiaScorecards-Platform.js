define("amber-ambercordova/CornucopiaScorecards-Platform", ["amber/boot"
//>>excludeStart("imports", pragmas.excludeImports);
, "amber/jquery/Wrappers-JQuery"
//>>excludeEnd("imports");
, "amber_core/Kernel-Objects", "amber_core/Kernel-Collections"], function($boot
//>>excludeStart("imports", pragmas.excludeImports);
...
$core.packages["CornucopiaScorecards-Platform"].transport = {"type":"amd","amdNamespace":"amber-ambercordova"};
$core.addMethod(
$core.method({
...
return $1;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
}, function($ctx1) {$ctx1.fill(self,"downloadAll",{response:response},$globals.UndefinedObject)});
//>>excludeEnd("ctx");
},
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
