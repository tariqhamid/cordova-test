define("amber-ambercordova/AmberVideo-Tests", ["amber/boot", "amber/web/Web"], function($boot){"use strict";
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
$core.addPackage('AmberVideo-Tests');
$core.packages["AmberVideo-Tests"].innerEval = function (expr) { return eval(expr); };
$core.packages["AmberVideo-Tests"].transport = {"type":"amd","amdNamespace":"amber-ambercordova"};
...
args: [],
source: "ensureVideo\x0a\x09self videoController playAudio: false.\x0a\x09self videoController showControls: false.\x0a\x09self videoController width: 320.\x0a\x09self videoController height: 240.\x0a\x09self videoController configureVideo.",
referencedClasses: [],
//>>excludeEnd("ide");
...
//>>excludeEnd("ctx");
var $1,$2;
tag=$recv($recv($HTMLCanvas())._onJQuery_("#amber-video"._asJQuery()))._root();
$1=$recv(html)._div();
...
return self;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
}, function($ctx1) {$ctx1.fill(self,"renderOn:",{html:html,tag:tag},$globals.AmberResizeableWebCamTest)});
//>>excludeEnd("ctx");
},
//>>excludeStart("ide", pragmas.excludeIdeData);
args: ["html"],
source: "renderOn: html\x0a\x09|tag|\x0a\x22\x0a html div class: 'wrapper';\x0a \x09with:[ \x0a\x09\x09self renderSliderOn: html.\x0a\x09\x09html br.\x0a\x09\x09html  video id: self videoController cssId.\x0a\x09\x09\x0a\x09].\x0a\x22\x0a\x22\x0a\x09tag := (HTMLCanvas onJQuery: '#output-list' asJQuery) root.\x0a\x09tag with: [ :html | html li with: 'Amber Web #with: added me!' ]\x0a\x22\x0a\x09tag := (HTMLCanvas onJQuery: '#amber-video' asJQuery) root.\x0a\x09tag with: (html\x0a\x09div class: 'wrapper';\x0a \x09with:[ \x0a\x09\x09self renderSliderOn: html.\x0a\x09\x09html br.\x0a\x09\x09html  video id: self videoController cssId.\x0a\x09\x09\x0a\x09]).\x0a\x09self ensureVideo",
referencedClasses: ["HTMLCanvas"],
//>>excludeEnd("ide");
messageSends: ["root", "onJQuery:", "asJQuery", "with:", "class:", "div", "renderSliderOn:", "br", "id:", "video", "cssId", "videoController", "ensureVideo"]
}),
$globals.AmberResizeableWebCamTest);
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "ensureVideo\x0a\x09self videoController playAudio: false.\x0a\x09self videoController showControls: false.\x0a\x09self videoController configureVideo.",
referencedClasses: [],
//>>excludeEnd("ide");
