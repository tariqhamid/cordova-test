...
, "amber-ambercordova/Examples-Paper", "amber-ambercordova/WebSocket-Test", "amber-ambercordova/AmberVideo", "amber-ambercordova/AmberVideo-Tests", "amber-ambercordova/AmberSnapsvg", "amber-ambercordova/Boomerang", "amber-ambercordova/Boomerang-Tests", "amber-ambercordova/CornucopiaScorecards-Platform", "amber-ambercordova/CornucopiaScorecards", "amber-ambercordova/CornucopiaScorecards-Tests", "amber-ambercordova/CornucopiaScorecardsApp", "amber-ambercordova/LindaClient", "amber-ambercordova/LindaClient-Tests", "amber-ambercordova/LindaClientDemo", "amber-ambercordova/Timer", "amber-ambercordova/Timer-Tests", "amber-ambercordova/TodoList", "amber-ambercordova/TwitterWall", "amber-ambercordova/Zendo", "amber-ambercordova/Zendo-Tests", "amber/jquery/Wrappers-JQuery", "amber/web/Web", "silk/Silk"
//>>excludeEnd("imports");
...
$core.packages["AmberCordova"].imports = ["amber-ambercordova/AmberSnapsvg", "amber-ambercordova/AmberVideo", "amber-ambercordova/AmberVideo-Tests", "amber-ambercordova/Boomerang", "amber-ambercordova/Boomerang-Tests", "amber-ambercordova/CornucopiaScorecards", "amber-ambercordova/CornucopiaScorecards-Platform", "amber-ambercordova/CornucopiaScorecards-Tests", "amber-ambercordova/CornucopiaScorecardsApp", "amber-ambercordova/Examples-Paper", "amber-ambercordova/LindaClient", "amber-ambercordova/LindaClient-Tests", "amber-ambercordova/LindaClientDemo", "amber-ambercordova/Timer", "amber-ambercordova/Timer-Tests", "amber-ambercordova/TodoList", "amber-ambercordova/TwitterWall", "amber-ambercordova/WebSocket-Test", "amber-ambercordova/Zendo", "amber-ambercordova/Zendo-Tests", "amber/jquery/Wrappers-JQuery", "amber/web/Web", "silk/Silk"];
