...
(function(global) {
        ...
        if (!this.inited) hasProp(r.defQueueMap, n) || this.fetch();
          ...
          if (this.depCount < 1 && !this.defined) {
            if (isFunction(o)) {
              ...
              if (e) {
                if (this.events.error && this.map.isDefine || req.onError !== defaultOnError) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", T(this.error = e);
                typeof console != "undefined" && console.error ? console.error(e) : req.onError(e)
              }
            } else s = o;
            this.exports = s;
  ...
  typeof require != "undefined" && !isFunction(require) && (cfg = require, require = undefined), req = requirejs = function(e, t, n, r) {
    ...
    var r = e && e.config || {},
      i;
    if (isBrowser) return i = req.createNode(r, t, n), r.onNodeCreated && r.onNodeCreated(i, r, t, n), i.setAttribute("data-requirecontext", e.contextName), i.setAttribute("data-requiremodule", t), i.attachEvent && !(i.attachEvent.toString && i.attachEvent.toString().indexOf("[native code") < 0) && !isOpera ? (useInteractive = !0, i.attachEvent("onreadystatechange", e.onScriptLoad)) : (i.addEventListener("load", e.onScriptLoad, !1), i.addEventListener("error", e.onScriptError, !1)), i.src = n, currentlyAddingScript = i, baseElement ? head.insertBefore(i, baseElement) : head.appendChild(i), currentlyAddingScript = null, i;
    if (isWebWorker) try {
...
})(this), define("node_modules/requirejs/require", function() {});
var require;
require || (require = {
  config: function(e) {
    require = e
  ...
  shim: {
    ...
    "codemirror/lib/codemirror": {
      deps: ["css!codemirror/lib/codemirror", "css!codemirror/lib/codemirror"]
    },
...
}), define("config", function() {}), define("amber_core/Platform-Browser", ["amber/boot", "amber_core/Kernel-Objects"], function($boot) {
  "use strict";
  var $core = $boot.api,
    nil = $boot.nil,
    $recv = $boot.asReceiver,
    $globals = $boot.globals;
  $core.addPackage("Platform-Browser"), $core.packages["Platform-Browser"].innerEval = function(expr) {
    return eval(expr)
  }, $core.packages["Platform-Browser"].transport = {
    type: "amd",
    amdNamespace: "amber_core"
  }, $core.addClass("BrowserPlatform", $globals.Object, [], "Platform-Browser"), $globals.BrowserPlatform.comment = "I am `Platform` service implementation for browser.", $core.addMethod($core.method({
    selector: "globals",
    protocol: "accessing",
    fn: function() {
      var e = this,
    ...
    referencedClasses: [],
    messageSends: []
  }), $globals.BrowserPlatform), $core.addMethod($core.method({
    selector: "newXhr",
    protocol: "accessing",
    fn: function() {
      function t() {
        return $globals.XMLHttpRequest || (typeof XMLHttpRequest == "undefined" ? nil : XMLHttpRequest)
      }

      function n() {
        return $globals.NativeFunction || (typeof NativeFunction == "undefined" ? nil : NativeFunction)
      }
      var e = this;
      return $core.withContext(function(r) {
        var i, s;
        return (s = t()) != null && !s.isNil ? (i = $recv(n())._constructorOf_(t()), i) : (e._error_("XMLHttpRequest not available."), e)
      }, function(t) {
        t.fill(e, "newXhr", {}, $globals.BrowserPlatform)
      })
    },
    args: [],
    ...
    fn: function() {
      function t() {
        return $globals.Platform || (typeof Platform == "undefined" ? nil : Platform)
      }
      var e = this;
      return $core.withContext(function(n) {
        var r;
        return r = e._isFeasible(), $core.assert(r) && $recv(t())._registerIfNone_(e._new()), e
      }, function(t) {
        t.fill(e, "initialize", {}, $globals.BrowserPlatform.klass)
      })
    },
    args: [],
  ...
  }), $globals.BrowserPlatform.klass), $core.addMethod($core.method({
    selector: "isFeasible",
    protocol: "testing",
    fn: function() {
      var e = this;
      return $core.withContext(function(t) {
        return typeof window != "undefined"
      }, function(t) {
        t.fill(e, "isFeasible", {}, $globals.BrowserPlatform.klass)
      })
    },
    args: [],
    source: 'isFeasible\n<return typeof window !== "undefined">',
    referencedClasses: [],
    messageSends: []
  }), $globals.BrowserPlatform.klass), $core.addClass("BrowserTerminal", $globals.Object, [], "Platform-Browser"), $globals.BrowserTerminal.comment = "I am `Terminal` service implementation for browser.", $core.addMethod($core.method({
    selector: "alert:",
    protocol: "actions",
    fn: function(e) {
      var t = this;
      return $core.withContext(function(t) {
        var n;
        return n = $recv(window)._alert_(e), n
      }, function(n) {
        n.fill(t, "alert:", {
          aString: e
    ...
    args: ["aString"],
    source: "alert: aString\n	^ window alert: aString",
    referencedClasses: [],
    messageSends: ["alert:"]
  }), $globals.BrowserTerminal), $core.addMethod($core.method({
    selector: "confirm:",
    protocol: "actions",
    fn: function(e) {
      var t = this;
      return $core.withContext(function(t) {
        var n;
        return n = $recv(window)._confirm_(e), n
      }, function(n) {
        n.fill(t, "confirm:", {
          aString: e
        }, $globals.BrowserTerminal)
    ...
    fn: function(e) {
      ...
      return $core.withContext(function(t) {
        var n;
        return n = $recv(window)._prompt_(e), n
      }, function(n) {
        n.fill(t, "prompt:", {
          aString: e
        }, $globals.BrowserTerminal)
    ...
    fn: function(e, t) {
      ...
      return $core.withContext(function(n) {
        var r;
        return r = $recv(window)._prompt_default_(e, t), r
      }, function(r) {
        r.fill(n, "prompt:default:", {
          aString: e,
          defaultString: t
        }, $globals.BrowserTerminal)
      })
    ...
    source: "prompt: aString default: defaultString\n	^ window prompt: aString default: defaultString",
    referencedClasses: [],
    ...
    fn: function() {
      function t() {
        return $globals.Terminal || (typeof Terminal == "undefined" ? nil : Terminal)
      }
      var e = this;
      return $core.withContext(function(n) {
        var r;
        ...
        t.fill(e, "initialize", {}, $globals.BrowserTerminal.klass)
      })
    },
    args: [],
    ...
    messageSends: ["ifTrue:", "isFeasible", "registerIfNone:", "new"]
  }), $globals.BrowserTerminal.klass), $core.addMethod($core.method({
    selector: "isFeasible",
    protocol: "testing",
    fn: function() {
      var e = this;
      return $core.withContext(function(t) {
        ...
        t.fill(e, "isFeasible", {}, $globals.BrowserTerminal.klass)
      })
    },
    args: [],
    source: 'isFeasible\n<return typeof window !== "undefined">',
    ...
    fn: function(e) {
      ...
      return $core.withContext(function(n) {
        var r;
        return r = t._postMessageTo_origin_(e, "*"), r
      }, function(n) {
        n.fill(t, "postMessageTo:", {
          aFrame: e
        }, $globals.Object)
      })
    },
    args: ["aFrame"],
    source: "postMessageTo: aFrame\n^ self postMessageTo: aFrame origin: '*'",
    referencedClasses: [],
    messageSends: ["postMessageTo:origin:"]
  }), $globals.Object), $core.addMethod($core.method({
    ...
    args: ["aFrame", "aString"],
    source: "postMessageTo: aFrame origin: aString\n<return aFrame.postMessage(self, aString)>",
    referencedClasses: [],
    messageSends: []
  }), $globals.Object)
}), define("app", ["devel"], function(e) {
  return e
